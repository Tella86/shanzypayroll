...
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h6>Welcome, <?php echo htmlspecialchars($employee['name']); ?>!</h6>
            </div>
            <ul class="components" style="font-size: 12px;">
                <li><a href="javascript:void(0);" id="manageEmployeesLink"><i class="fas fa-users"></i> Manage
                        Employees</a></li>
                <li><a href="javascript:void(0);" id="processPayrollLink"><i class="fas fa-money-check-alt"></i> Process
                        Payroll</a></li>
                <li><a href="javascript:void(0);" id="viewproceedpayrollLink"><i class="fas fa-money-check-alt"></i>
                        View Payroll</a></li>
                <li><a href="javascript:void(0);" id="viewdeductionslink"><i class="fas fa-money-check-alt"></i> View
                        Deductions</a></li>
                <li><a href="javascript:void(0);" id="summarydeductionslink"><i
                            class="fas fa-money-check-alt"></i>Summary Deductions</a></li>
                <li><a href="javascript:void(0);" id="auditLogsLink"><i class="fas fa-file-alt"></i> Audit Logs</a></li>
                <li><a href="javascript:void(0);" id="viewEmployeesLink"><i class="fas fa-users"></i> View Employees</a>
                </li>
                <li><a href="javascript:void(0);" id="updatepasswordLink"><i class="fas fa-key"></i>update Password</a>
                </li>
        ...
        <!-- Page Content -->
        <div id="content">
            <button type="button" id="sidebarCollapse" class="btn toggle-btn" style="color: #4cc9f0;">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card bg-light mb-3">
                        <div class="card-header" style="background-color: #4cc9f0;"><a href="view_employees.php"
                                style=" color: white;">Total Employees</a></div>
    ...
    $(document).ready(function() {
        ...
        function loadContent(pageUrl) {
            $('#content-area').fadeOut(180, function() { // First, fade out the current content
                $('#content-area').load(pageUrl, function() {
                    $('#content-area').fadeIn(180); // Then, load the new content and fade it in
                });
            });
        ...
        $('#summarydeductionslink').on('click', function() {
            loadContent('summary_deductions.php');
        });
